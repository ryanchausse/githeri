...
$(document).ready(function() {
    ...
    $("<link/>", {
     ...
     $("<link/>", {
        rel: "stylesheet",
        type: "text/css",
        href: "./resources/soundmanager2/css/mp3-player-button.css"
    }).appendTo("head");
    soundManager.setup({
        // required: path to directory containing SM2 SWF files
        url: "./resources/soundmanager2/swf/"
    });
</script>
<div style="display:none;">
    <img src='./resources/images/health5.png'>
    <img src='./resources/images/health4.png'>
    <img src='./resources/images/health3.png'>
    <img src='./resources/images/health2.png'>
    <img src='./resources/images/health1.png'>
    <img src='./resources/images/health0.png'>
</div>
<div class="phrasesectwrap">
    <div id= "endoflearnwords" class="endoflearnwords">
        ...
        <div class="mainbarwrap">
            <div class="donemsg">
                No more phrases to learn.
            </div>
            <div class="imgdone">
                <div id="startover" class="startover">Start Over</div>
            </div>
        </div>
        <div class="lowerbar">
    ...
    <div id="correctscrn" class="correctscrn">
        <div class="topbar">
            <div class="introtopbarleft"><?php //echo $subcat; ?></div>
        </div>
        <div class="mainbarwrap">
            ...
            <div class="imgright">
                <img src="./resources/images/checkmark.png">
            </div>
        </div>
        <div class="lowerbar">
            <div class="lowerbarleft"></div><div class="introhintbutton"><div class="hiddenanswer"></div></div><div class="nextbutton">Next<div class="hiddenanswer"></div></div>
        </div>
    </div>
    <div id="wrongscrn" class="wrongscrn">
        <div class="topbar">
            <div class="introtopbarleft"><?php //echo $subcat; ?></div>
        </div>
        <div class="mainbarwrap">
            ...
            <div class="imgwrong">
                <img src="./resources/images/xmark.png">
            </div>
        </div>
        <div class="lowerbar">
            <div class="lowerbarleft"></div><div class="introhintbutton"><div class="hiddenanswer"></div></div><div class="backbutton">Back<div class="hiddenanswer"></div></div>
        </div>
    </div>
    <div id="failscrn" class="failscrn">
        <div class="topbar">
            <div class="introtopbarleft"><?php //echo $subcat; ?></div>
        </div>
        <div class="mainbarwrap">
            <div class="failmsg">
                You have answered incorrectly too many times.
            </div>
            <div class="imgfail">
                <div id="startover" class="startover">Start Over</div>
            </div>
...
if ($loginstatus){
?>
    <div id="lastscr" class="lastscr">
        <div class="topbar">
            <div class="introtopbarleft"><?php //echo $subcat; ?></div>
        </div>
        <div class="mainbarwrap">
            <div class="savereturnmsg">
                Finished!
            </div>
            <?php
                if (isset($_POST["phraseexactnm"])){
                    $subcat = dbSanitise($_POST["phraseexactnm"]);
                }else{
                    die("You have to specify a phrase.");
                }
            ?>
            <div class="savereturnimg" style="margin-top:20px;">
                <form method="post" action="#">
                    <input type="hidden" name="formtype" value="saveandreturn">
                    <input type="hidden" name="subcatname" value="<?php echo $subcat; ?>">
    ...
    <div id="lastscr" class="lastscr">
        ...
        <div class="mainbarwrap">
            <div class="donenosigninmsg">
                Congratulations! You've passed.<br /><br />Now Sign Up to track your progress and chat with other Kiswahili speakers.
            </div>
            <div class="signupbutton"></div>
            <div id="returntofirstscrn" class="startover">Interactive Lessons</div>
        </div>
        <div class="lowerbar">
            <div class="lowerbarleft"></div><div class="introhintbutton"><div class="hiddenanswer"></div></div><div class="introlearnnext"><div class="hiddenanswer"></div></div>
        </div>
...
if (isset($_POST["phraseexactnm"])){
    $subcat = sanitisedata($_POST["phraseexactnm"]);
}else{
    die("You have to specify a phrase.");
}

$subcatsql = "SELECT * FROM phrases WHERE ((sub_cat ='".$subcat."') AND (lesson_txt1 = ''))";
$subcatresult = selectNoEmptyHandling($subcatsql);
if ($subcatresult ->num_rows < 1){
    echo "No phrases found for this sub-category.";
}else{
    while($subcatrow = mysqli_fetch_array($subcatresult)){
        $phrases[$i]["swa_phrase"] = $subcatrow["swa_phrase"];
        $phrases[$i]["eng_phrase"] = $subcatrow["eng_phrase"];
        $phrases[$i]["swa_audio"] = $subcatrow["swa_audio_file_name"];
        $phrases[$i]["eng_audio"] = $subcatrow["eng_audio_file_name"];
        $phrases[$i]["alt_swa1"] = $subcatrow["alt_swa_1"];
        $phrases[$i]["alt_swa2"] = $subcatrow["alt_swa_2"];
        $phrases[$i]["alt_swa3"] = $subcatrow["alt_swa_3"];
        $phrases[$i]["alt_swa4"] = $subcatrow["alt_swa_4"];
        $phrases[$i]["alt_swa5"] = $subcatrow["alt_swa_5"];
        $phrases[$i]["alt_swa6"] = $subcatrow["alt_swa_6"];
        $phrases[$i]["alt_swa7"] = $subcatrow["alt_swa_7"];
        $phrases[$i]["alt_swa8"] = $subcatrow["alt_swa_8"];
        $phrases[$i]["alt_swa9"] = $subcatrow["alt_swa_9"];
        $phrases[$i]["alt_swa10"] = $subcatrow["alt_swa_10"];
        $phrases[$i]["alt_eng1"] = $subcatrow["alt_eng_1"];
        $phrases[$i]["alt_eng2"] = $subcatrow["alt_eng_2"];
        $phrases[$i]["alt_eng3"] = $subcatrow["alt_eng_3"];
        $phrases[$i]["alt_eng4"] = $subcatrow["alt_eng_4"];
        $phrases[$i]["alt_eng5"] = $subcatrow["alt_eng_5"];
        $phrases[$i]["alt_eng6"] = $subcatrow["alt_eng_6"];
        $phrases[$i]["alt_eng7"] = $subcatrow["alt_eng_7"];
        $phrases[$i]["alt_eng8"] = $subcatrow["alt_eng_8"];
        $phrases[$i]["alt_eng9"] = $subcatrow["alt_eng_9"];
        $phrases[$i]["alt_eng10"] = $subcatrow["alt_eng_10"];
        $phrases[$i]["wrng_swa1"] = $subcatrow["wrng_swa_1"];
        $phrases[$i]["wrng_swa2"] = $subcatrow["wrng_swa_2"];
        $phrases[$i]["wrng_swa3"] = $subcatrow["wrng_swa_3"];
        $phrases[$i]["wrng_eng1"] = $subcatrow["wrng_eng_1"];
        $phrases[$i]["wrng_eng2"] = $subcatrow["wrng_eng_2"];
        $phrases[$i]["wrng_eng3"] = $subcatrow["wrng_eng_3"];
        $phrases[$i]["addedbyid"] = $subcatrow["added_by_userid"];
...
?>
<script type='text/javascript'>
    termcounter = <?php echo count($phrases); ?>;
</script>
<div id="firstscrn" class="firstscrn">
    ...
    <div class="mainbarwrap">
        <div class="intromainleft">
            <div class="phrasedesc">Learn the Words</div>
            <div id="learnwordsbutton" class="introunderphrasedesc">Go</div>
        </div>
        <div class="intromainright">
            <div class="introinstructdesc">Take the Test</div>
            <div id="taketestbutton" class="introlearnunderinstructdesc">Go</div>
        </div>
    </div>
    <div class="lowerbar">
        <div class="lowerbarleft"></div><div class="introhintbutton"><div class="hiddenanswer"></div></div><div class="introlearnnext"><div class="hiddenanswer"></div></div>
...
function createlearndiv($phrasearr, $hiddenlearnphrasecounter){
    echo "<div id='hiddenlearn_".$hiddenlearnphrasecounter."' class='hiddenlearnsection'>";
    ?>
    <div class="topbar">
    ...
    <div class="mainbarwrap">
        <div class="mainleft">
            <div class="phrasedesc">English Phrase</div>
            <div class="underphrasedesc">
                <?php echo $phrasearr['eng_phrase']; ?>
                <br />
                <?php echo "<a id='eaud_".$hiddenlearnphrasecounter."' href='./resources/audio/mp3/".htmlentities($phrasearr['eng_audio'])."?currenttimelearn0".$hiddenlearnphrasecounter."=".date("Y-m-d H:i:s")."' class='sm2_button'>Play</a>"; ?>
            </div>
        </div>
        <div class="mainright">
            <div class="instructdesc">Kiswahili Translation</div>
            <div class="learnunderinstructdesc">
                <?php echo $phrasearr['swa_phrase']; ?>
                <br />
                <?php echo "<a id='kaud_".$hiddenlearnphrasecounter."' href='./resources/audio/mp3/".htmlentities($phrasearr['swa_audio'])."?currenttimelearn1".$hiddenlearnphrasecounter."=".date("Y-m-d H:i:s")."' class='sm2_button'>Play</a>"; ?>
            </div>
        </div>
    </div>
    <div class="lowerbar">
        <div class="lowerbarleft"></div><div class="introhintbutton"><div class="hiddenanswer"><?php echo $phrasearr['eng_phrase']; ?></div></div><div class="learnnext">Next<div class="hiddenanswer"><?php echo $phrasearr['eng_phrase']; ?></div></div>
    </div>
    <?php
    echo "</div>";
...
function seephrasetypetrans($phrasearr, $hiddendivcounter){
    $engfirst = rand(0,1);
    echo "<div id='hiddenphrase_".$hiddendivcounter."' class='hiddensection'>";
    echo "<div id='useranswer_".$hiddendivcounter."' class='usranswr'></div>";
    if ($engfirst == 0){
    ?>
        <div class="topbar">
            <div class="topbarleft"></div><div class="topbarright"><img src='./resources/images/health5.png'></div>
        </div>
        <div class="mainbarwrap">
            <div class="mainleft">
                <div class="phrasedesc">Kiswahili Phrase</div>
                <div class="underphrasedesc"><?php echo $phrasearr['swa_phrase']; ?></div>
            </div>
            <div class="mainright">
                <div class="instructdesc">English Translation</div>
                <div class="underinstructdesc"><textarea class="txtareaunderinstructdesc"></textarea></div>
            </div>
        </div>
        <div class="lowerbar">
            <div class="lowerbarleft"></div><div class="hidehintbutton"></div><div class="hintbutton">Cheat<div class="hiddenanswer"><?php echo $phrasearr['eng_phrase']; ?></div></div><div class="submitresponse">Submit<div class="hiddenanswer"><?php echo $phrasearr['eng_phrase']; ?></div></div>
        </div>
    <?php
    }else{
    ?>
        ...
        <div class="mainbarwrap">
            <div class="mainleft">
                <div class="phrasedesc">English Phrase</div>
                <div class="underphrasedesc"><?php echo $phrasearr['eng_phrase']; ?></div>
            </div>
            <div class="mainright">
                <div class="instructdesc">Kiswahili Translation</div>
                <div class="underinstructdesc"><textarea class="txtareaunderinstructdesc"></textarea></div>
        ...
        <div class="lowerbar">
            <div class="lowerbarleft"></div><div class="hidehintbutton"></div><div class="hintbutton">Cheat<div class="hiddenanswer"><?php echo $phrasearr['swa_phrase']; ?></div></div><div class="submitresponse">Submit<div class="hiddenanswer"><?php echo $phrasearr['swa_phrase']; ?></div></div>
        </div>
    <?php
    }
    echo "</div>";
    $hiddendivcounter++;
    return $hiddendivcounter;
}

function listenphrasetypetrans($phrasearr, $hiddendivcounter){
    $engfirst = rand(0,1);
    echo "<div id='hiddenphrase_".$hiddendivcounter."' class='hiddensection'>";
    echo "<div id='useranswer_".$hiddendivcounter."' class='usranswr'></div>";
    if ($engfirst == 0){
        ...
        <div class="mainbarwrap">
            <div class="mainleft">
                <div class="phrasedesc">Kiswahili Audio</div>
                <div class="underphrasedesc"><?php echo "<a href='./resources/audio/mp3/".htmlentities($phrasearr['swa_audio'])."?currenttime0".$hiddendivcounter."=".date("Y-m-d H:i:s")."' class='sm2_button'>Play</a>"; ?></div>
            </div>
            <div class="mainright">
                <div class="instructdesc">English Translation</div>
                <div class="underinstructdesc"><textarea class="txtareaunderinstructdesc"></textarea></div>
    ...
    <?php
        ...
        <div class="mainbarwrap">
            <div class="mainleft">
                <div class="phrasedesc">English Audio</div>
                <div class="underphrasedesc"><?php echo "<a href='./resources/audio/mp3/".htmlentities($phrasearr['eng_audio'])."?currenttime1".$hiddendivcounter."=".date("Y-m-d H:i:s")."' class='sm2_button'>Play</a>"; ?></div>
            </div>
            <div class="mainright">
                <div class="instructdesc">Kiswahili Translation</div>
                <div class="underinstructdesc"><textarea class="txtareaunderinstructdesc"></textarea></div>
...
function listenswatypeswa($phrasearr, $hiddendivcounter){
    //no $engfirst var, only working with Swahili
    echo "<div id='hiddenphrase_".$hiddendivcounter."' class='hiddensection'>";
    echo "<div id='useranswer_".$hiddendivcounter."' class='usranswr'></div>";
    ?>
        <div class="topbar">
        ...
        <div class="mainbarwrap">
            <div class="mainleft">
                <div class="phrasedesc">Kiswahili Audio</div>
                <div class="underphrasedesc"><?php echo "<a href='./resources/audio/mp3/".htmlentities($phrasearr['swa_audio'])."?currenttime2".$hiddendivcounter."=".date("Y-m-d H:i:s")."' class='sm2_button'>Play</a>"; ?></div>
            </div>
            <div class="mainright">
                <div class="instructdesc">Type in Kiswahili</div>
                <div class="underinstructdesc"><textarea class="txtareaunderinstructdesc"></textarea></div>
            </div>
        </div>
        <div class="lowerbar">
...
function listenphraseselectcorrect($phrasearr, $hiddendivcounter){
    $engfirst = rand(0,1);
    echo "<div id='hiddenphrase_".$hiddendivcounter."' class='hiddensection'>";
    echo "<div id='useranswer_".$hiddendivcounter."' class='usranswr'></div>";
    if ($engfirst == 0){
        ...
        <div class="mainbarwrap">
            <div class="mainleft">
                <div class="phrasedesc">Kiswahili Audio</div>
                <div class="underphrasedesc"><?php echo "<a href='./resources/audio/mp3/".htmlentities($phrasearr['swa_audio'])."?currenttime3".$hiddendivcounter."=".date("Y-m-d H:i:s")."' class='sm2_button'>Play</a>"; ?></div>
            </div>
            <div class="mainright">
                <div class="instructdesc">English Translation</div>
                <?php //create array of the following and shuffle, then echo as choices ?>
                <?php $answershuffle = array();?>
                <?php $answershuffle[0] = htmlentities($phrasearr['alt_eng1']); ?>
                <?php $answershuffle[1] = htmlentities($phrasearr['alt_eng2']); ?>
                <?php $answershuffle[2] = htmlentities($phrasearr['alt_eng3']); ?>
                <?php $answershuffle[3] = htmlentities($phrasearr['eng_phrase']); ?>
                <?php shuffle($answershuffle); ?>
                <div class="underinstructdesc" style="text-align: left;">
                    <!--
                    <select class='selectans'>
                        <option value="">Select the correct phrase</option>
                        <option value="<?php //echo $answershuffle[0]; ?>"><?php //echo $answershuffle[0]; ?></option>
                        <option value="<?php //echo $answershuffle[1]; ?>"><?php //echo $answershuffle[1]; ?></option>
                        <option value="<?php //echo $answershuffle[2]; ?>"><?php //echo $answershuffle[2]; ?></option>
                        <option value="<?php //echo $answershuffle[3]; ?>"><?php //echo $answershuffle[3]; ?></option>
                    </select>
                    -->
                    Select the correct phrase:
                    <br /><br />
                    <input type="radio" name="ans" class="ans" id="<?php echo $answershuffle[0]; ?>" value="<?php echo $answershuffle[0]; ?>">
                    <label class="anslbl" for="<?php echo $answershuffle[0]; ?>"><?php echo $answershuffle[0]; ?></label>
                    <br />
                    <input type="radio" name="ans" class="ans" id="<?php echo $answershuffle[1]; ?>" value="<?php echo $answershuffle[1]; ?>">
                    <label class="anslbl" for="<?php echo $answershuffle[1]; ?>"><?php echo $answershuffle[1]; ?></label>
                    <br />
                    <input type="radio" name="ans" class="ans" id="<?php echo $answershuffle[2]; ?>" value="<?php echo $answershuffle[2]; ?>">
                    <label class="anslbl" for="<?php echo $answershuffle[2]; ?>"><?php echo $answershuffle[2]; ?></label>
                    <br />
                    <input type="radio" name="ans" class="ans" id="<?php echo $answershuffle[3]; ?>" value="<?php echo $answershuffle[3]; ?>">
                    <label class="anslbl" for="<?php echo $answershuffle[3]; ?>"><?php echo $answershuffle[3]; ?></label>
                </div>
            </div>
        </div>
        <div class="lowerbar">
    ...
    <?php
        ...
        <div class="mainbarwrap">
            <div class="mainleft">
                <div class="phrasedesc">English Audio</div>
                <div class="underphrasedesc"><?php echo "<a href='./resources/audio/mp3/".htmlentities($phrasearr['eng_audio'])."?currenttime4".$hiddendivcounter."=".date("Y-m-d H:i:s")."' class='sm2_button'>Play</a>"; ?></div>
            </div>
            <div class="mainright">
                <div class="instructdesc">Kiswahili Translation</div>
                <?php //create array of the following and shuffle, then echo as choices ?>
                <?php $answershuffle = array();?>
                <?php $answershuffle[0] = htmlentities($phrasearr['alt_swa1']); ?>
                <?php $answershuffle[1] = htmlentities($phrasearr['alt_swa2']); ?>
                <?php $answershuffle[2] = htmlentities($phrasearr['alt_swa3']); ?>
                <?php $answershuffle[3] = htmlentities($phrasearr['swa_phrase']); ?>
                <?php shuffle($answershuffle); ?>
                <div class="underinstructdesc" style="text-align: left;">
                    <!--
                    <select class='selectans'>
...
function seephraseselectcorrect($phrasearr, $hiddendivcounter){
    $engfirst = rand(0,1);
    echo "<div id='hiddenphrase_".$hiddendivcounter."' class='hiddensection'>";
    echo "<div id='useranswer_".$hiddendivcounter."' class='usranswr'></div>";
    if ($engfirst == 0){
...
for ($gotwice=0;$gotwice<=1;$gotwice++){
    for($counter = 0;$counter < count($phrases);$counter++){
        $rndlsntype = rand(0,4);
        switch($rndlsntype){
            case 0:
                $hiddendivcounter = seephrasetypetrans($phrases[$counter], $hiddendivcounter);
                break;
            case 1:
                $hiddendivcounter = listenphrasetypetrans($phrases[$counter], $hiddendivcounter);
                break;
            case 2:
                $hiddendivcounter = listenswatypeswa($phrases[$counter], $hiddendivcounter);
                break;
            case 3:
                $hiddendivcounter = listenphraseselectcorrect($phrases[$counter], $hiddendivcounter);
                break;
            case 4:
                $hiddendivcounter = seephraseselectcorrect($phrases[$counter], $hiddendivcounter);
                break;
            default:
                echo "No test type was provided for some reason.";
                break;
        }
    }
}
for($counter = 0;$counter < count($phrases);$counter++){
    $hiddenlearnphrasecounter = createlearndiv($phrases[$counter], $hiddenlearnphrasecounter);
}
?>
<?php
    if ($loginstatus){
