...
if (file_exists('../../../../functions/sqlconnectandselect.php')){
    include '../../../../functions/sqlconnectandselect.php';
}else{
    include '../../functions/sqlconnectandselect.php';
}
    $sqlstring = "SELECT english_phrase, swahili_phrase, mp3name FROM quick_ref";
    $result = selectFromDB($sqlstring);
    $sqlstring1 = "SELECT eng_phrase, swa_phrase, swa_audio_file_name FROM phrases";
    $result1 = selectFromDB($sqlstring1);
?>
<script type="text/javascript">
    try {
        if (typeof basicMP3Player === 'undefined') {
...
<script type="text/javascript">
    //$.getScript("./resources/soundmanager2/script/mp3-player-button.js");
    $("<link/>", {
        rel: "stylesheet",
        type: "text/css",
    ...
    $("<link/>", {
        rel: "stylesheet",
        type: "text/css",
        href: "./resources/css/quickreference.css"
     }).appendTo("head");
    //$.getScript("./resources/soundmanager2/script/soundmanager2.js");
    $.getScript("./resources/js/quickreference.js");
    soundManager.setup({
...
<div class="quickreftbl">
    <table>
        <tr>
            <th>English</th><th>Swahili</th>
        </tr>
        <?php
            while($row = mysqli_fetch_array($result)){
                echo "<tr><td>".$row["english_phrase"]."</td><td>".$row["swahili_phrase"]."&nbsp;&nbsp;&nbsp;<a href='./resources/audio/mp3/".$row["mp3name"].".mp3' class='sm2_button'>Play</a></td></tr>";
            }
            while($row1 = mysqli_fetch_array($result1)){
                echo "<tr><td>".$row1["eng_phrase"]."</td><td>".$row1["swa_phrase"]."&nbsp;&nbsp;&nbsp;<a href='./resources/audio/mp3/".$row1["swa_audio_file_name"]."' class='sm2_button'>Play</a></td></tr>";
            }
        ?>
    </table>
    <br style='clear:both;'/>
