            ...
            if (!$this->db_connection->connect_errno) {
                ...
                if ($checklogin->num_rows == 1) {
                    ...
                    if (password_verify($_POST['user_password'], $result_row->user_password_hash)) {
                        ...
                        include_once '/var/www/kiswahili2/resources/php/functions/sqlconnectandselect.php';
                        ...
                        $updatelastloggedin = "UPDATE users SET lastloggedin='".$time."' WHERE user_id='".$userid."';";
                        $result = executeSQLtoDB($updatelastloggedin);
                    } else {
